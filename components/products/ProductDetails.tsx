  ...
  const addToCart = () => {
    if (product.product_id) {
      ...
      if (cartData !== undefined && cartData !== null && cartData !== "") {
        ...
        let existDataFind = existDataList.findIndex(
          (obj: CartList) => obj.product_id === product.product_id
        );
        if (existDataFind !== -1) {
          let updateData = existDataList;
          updateData[existDataFind].qty = updateData[existDataFind].qty + 1;
